...
_2[_3]={prefix:_3,namespaceURI:_4,version:_5,extraData:_6};
this.publish(_1+"registerLibrary",_2[_3]);
};
h.unregisterLibrary=function(_7){
this.publish(_1+"unregisterLibrary",_2[_7]);
delete _2[_7];
};
...
h._publish=function(_18,_19,_1a,_1b,msg,pid){
if(typeof _18!="undefined"){
var _1c;
if(_1a==_19.length){
_1c=_18;
}else{
this._publish(_18.c[_19[_1a]],_19,_1a+1,_1b,msg,pid);
this._publish(_18.c["*"],_19,_1a+1,_1b,msg,pid);
_1c=_18.c["**"];
}
